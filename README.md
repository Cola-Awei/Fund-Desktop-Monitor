...
[下载 Windows 安装版](https://github.com/Cola-Awei/Fund-Desktop-Monitor/releases/latest/download/Fund-Desktop-Monitor-Setup-0.1.1.exe)
...
2. 下载 `Fund-Desktop-Monitor-Setup-0.1.1.exe`。
3. 双击安装程序完成安装。
...
```text
https://github.com/Cola-Awei/Fund-Desktop-Monitor/releases/latest/download/Fund-Desktop-Monitor-Setup-0.1.1.exe
```
...
```text
release/Fund Desktop Monitor Setup 0.1.1.exe
```
